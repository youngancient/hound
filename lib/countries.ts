/**
 * Officially assigned ISO 3166-1 alpha-2 codes. An explicit list, not
 * `Intl.DisplayNames`, because Intl happily names non-country codes —
 * "UK", "EU", "UN" all resolve — and "UK" in particular is the classic
 * wrong answer for the United Kingdom (it's "GB").
 */
